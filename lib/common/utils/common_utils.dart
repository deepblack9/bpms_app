...
import 'package:bpms_app/common/redux/locale_redux.dart';
import 'package:bpms_app/common/redux/theme_redux.dart';
...
class CommonUtils {
  ...
  static String getUserChartAddress(String userName) {
    return Address.graphicHost +
        BPMSColors.primaryValueString.replaceAll("#", "") +
        "/" +
        userName;
  }
   ...
   * 切换语言
   */
  static changeLocale(Store<BPMSState> store, int index) {
  ...
  static BPMSStringBase getLocale(BuildContext context) {
    return BPMSLocalizations.of(context).currentLocalized;
  }

  static List<Color> getThemeListColor() {
    return [
      BPMSColors.primarySwatch,
      Colors.brown,
      Colors.blue,
      Colors.teal,
      Colors.amber,
...
//      NavigatorUtils.goBPMSWebView(context, url, title);
    } else {
//      NavigatorUtils.goBPMSWebView(
//          context,
...
//          title);
  ...
  static Future<Null> showLoadingDialog(BuildContext context) {
    return NavigatorUtils.showBPMSDialog(
        context: context,
                  ...
                  child: new Container(
                    ...
                    child: new Column(
                      ...
                      children: <Widget>[
                        new Container(
                            child:
                                SpinKitCubeGrid(color: Color(BPMSColors.white))),
                        new Container(height: 10.0),
                        new Container(
                            child: new Text(
                                CommonUtils.getLocale(context).loading_text,
                                style: BPMSConstant.normalTextWhite)),
                      ],
                    ),
                  ),
                ),
              ...
              child: new ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return BPMSFlexButton(
                      ...
                      textColor: Color(BPMSColors.white),
                      onPress: () {
