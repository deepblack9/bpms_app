...
import 'package:bpms_app/common/redux/middleware/epic.dart';
import 'package:bpms_app/common/redux/middleware/epic_store.dart';
...
class UserInfoMiddleware implements MiddlewareClass<BPMSState> {

  @override
  void call(Store<BPMSState> store, dynamic action, NextDispatcher next) {
...
class UserInfoEpic implements EpicClass<BPMSState> {
  @override
  Stream<dynamic> call(Stream<dynamic> actions, EpicStore<BPMSState> store) {
