...
import 'package:bpms_app/widget/bpms_card_item.dart';
import 'package:bpms_app/widget/bpms_input_widget.dart';
                      ...
                      child: new Column(
                        ...
                        children: <Widget>[
                          ...
                          new Padding(
                              ...
                              child: new Center(
                                child: new Text(widget.dialogTitle, style: BPMSConstant.normalTextBold),
                              )),
                          ...
                          new Container(
                            ...
                            decoration: new BoxDecoration(
                              ...
                              border: new Border.all(color: Color(BPMSColors.subTextColor), width: .3),
                            ),
                                ...
                                new Expanded(
                                  child: new TextField(
                                    ...
                                    decoration: new InputDecoration.collapsed(
                                      hintText: CommonUtils.getLocale(context).issue_edit_issue_title_tip,
                                      hintStyle: BPMSConstant.middleSubText,
                                    ),
                                    style: BPMSConstant.middleText,
                                  ),
                                ),
                            ...
                            children: <Widget>[
                              ...
                              new Expanded(
                                  child: new RawMaterialButton(
                                      ...
                                      constraints: const BoxConstraints(minWidth: 0.0, minHeight: 0.0),
                                      child: new Text(CommonUtils.getLocale(context).app_cancel, style: BPMSConstant.normalSubText),
                                      onPressed: () {
                                        Navigator.pop(context);
                                      })),
                              new Container(width: 0.3, height: 25.0, color: Color(BPMSColors.subTextColor)),
                              ...
                              new Expanded(
                                  child: new RawMaterialButton(
                                      ...
                                      padding: EdgeInsets.all(4.0),
                                      constraints: const BoxConstraints(minWidth: 0.0, minHeight: 0.0),
                                      child: new Text(CommonUtils.getLocale(context).app_ok, style: BPMSConstant.normalTextBold),
...
var FAST_INPUT_LIST = [
  FastInputIconModel(BPMSICons.ISSUE_EDIT_H1, "\n# "),
  FastInputIconModel(BPMSICons.ISSUE_EDIT_H2, "\n## "),
  FastInputIconModel(BPMSICons.ISSUE_EDIT_H3, "\n### "),
  FastInputIconModel(BPMSICons.ISSUE_EDIT_BOLD, "****"),
  FastInputIconModel(BPMSICons.ISSUE_EDIT_ITALIC, "__"),
  FastInputIconModel(BPMSICons.ISSUE_EDIT_QUOTE, "` `"),
  FastInputIconModel(BPMSICons.ISSUE_EDIT_CODE, " \n``` \n\n``` \n"),
  FastInputIconModel(BPMSICons.ISSUE_EDIT_LINK, "[](url)"),
];
