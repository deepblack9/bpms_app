 ...
 * Date: 2018-07-16
 */
class BPMSCardItem extends StatelessWidget {
  final Widget child;
  ...
  BPMSCardItem({@required this.child, this.margin, this.color, this.shape, this.elevation = 5.0});
  ...
  Widget build(BuildContext context) {
    ...
    color ??= new Color(BPMSColors.cardWhite);
