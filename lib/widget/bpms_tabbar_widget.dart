...
class BPMSTabBarWidget extends StatefulWidget {
  ///底部模式type
  ...
  @override
  _BPMSTabBarState createState() => new _BPMSTabBarState(
        type,
        tabViews,
        indicatorColor,
        title,
...
class _BPMSTabBarState extends State<BPMSTabBarWidget>
  ...
  Widget build(BuildContext context) {
    if (this._type == BPMSTabBarWidget.TOP_TAB) {
      ///顶部tab bar
      return new Scaffold(
