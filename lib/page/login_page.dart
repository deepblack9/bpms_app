              ...
              child: SafeArea(
                ...
                child: SingleChildScrollView(
                  child: new Card(
                    ...
                    color: Color(BPMSColors.cardWhite),
                    ...
                    child: new Padding(
                      ...
                      child: new Column(
                        ...
                        children: <Widget>[
                          new Image(image: new AssetImage(BPMSICons.DEFAULT_USER_ICON), width: 90.0, height: 90.0),
                          new Padding(padding: new EdgeInsets.all(10.0)),
                          new BPMSInputWidget(
                            hintText: CommonUtils.getLocale(context).login_username_hint_text,
                            iconData: BPMSICons.LOGIN_USER,
